...
async function run() {
    try {
        ...
        const orgId = "c94e5553-3965-412a-b328-c9fa31d925e6"; // Oid from joinUrl
        
        console.log("Fetching onlineMeeting using Oid filter...");
        const res = await axios.get(
            `https://graph.microsoft.com/v1.0/users/${orgId}/onlineMeetings?$filter=joinWebUrl eq '${joinUrl}'`,
